...
export class TestScene extends Scene {
    ...
    private selectedCell: GridCoordinate | undefined = undefined as GridCoordinate | undefined;

    private selectedArea: GridCoordinate[] = [];
    ...
    public override Start(){
        MOUSE.addEvent("mousedown", () => {
            if(this.selectedArea.length === 0){
                this.selectedArea.push(this.hoveredCell as GridCoordinate)
            } else {
                this.selectedArea = [];
            }
        })
    ...
    public override Update(){
         ...
         */
        let endPosition: GridCoordinate | undefined = undefined as GridCoordinate | undefined;
        ...
        if(this.selectedArea !== undefined && this.selectedArea.length === 2){
            ...
            if(this.selectedArea[0].differentTo(this.selectedArea[1])){
                DRAW.Text(
                    `Selected area: [${this.selectedArea[0].x}, ${this.selectedArea[0].y}], [${this.selectedArea[1].x}, ${this.selectedArea[1].y}]`,
                    new Vector(SCREENSIZE.x - 20, 65),
                    "black",
                    undefined,
                    undefined,
                    "right"
            ...
            if(this.selectedArea[0].equalsTo(this.selectedArea[1])){
                DRAW.Text(
                    "Selected: " + this.selectedArea[0].x + ", " + this.selectedArea[0].y,
                    new Vector(SCREENSIZE.x - 20, 65),
                    "black",
                    undefined,
                    undefined,
        ...
        if(this.hoveredCell !== undefined && this.Map.dimensions.half !== undefined){
            if(this.Map.isInBounds(this.hoveredCell)){
                ...
                DRAW.Text(
                    "Hovered: " + this.hoveredCell.x + ", " + this.hoveredCell.y,
                    new Vector(SCREENSIZE.x - 20, 35),
                    "black",
                    undefined,
                    undefined,
                    "right"
